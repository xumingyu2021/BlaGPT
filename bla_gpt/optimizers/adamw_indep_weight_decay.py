# based on https://arxiv.org/pdf/2309.14322
# We do not multiply weight decay by learning rate
# It is not compatible with the fused implementation so we removed it.
